...
func (nameScoping *DefaultNameScopingImpl) Handle(command utils.CommandEnum, cluster cluster.Cluster, w http.ResponseWriter, r *http.Request, swarmHandler http.Handler) error {
	...
	case c.CONTAINER_JSON, c.CONTAINER_START, c.CONTAINER_STOP, c.CONTAINER_RESTART, c.CONTAINER_DELETE, c.CONTAINER_WAIT, c.CONTAINER_ARCHIVE, c.CONTAINER_KILL, c.CONTAINER_PAUSE, c.CONTAINER_UNPAUSE, c.CONTAINER_UPDATE, c.CONTAINER_COPY, c.CONTAINER_CHANGES, c.CONTAINER_ATTACH, c.CONTAINER_LOGS, c.CONTAINER_TOP:
